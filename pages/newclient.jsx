                ...
                <div className="shadow overflow-hidden sm:rounded-md">
                    <div className="px-9 py-5 bg-white sm:p-6">
                        ...
                        <div className="col-span-9 sm:col-span-3">
                            ...
                            <input id="firstName" type="text" name="firstName" {...register('firstName')} className="flex-1 w-3/4 py-2 text-center border-b-2 border-gray-400 focus:border-green-400 text-gray-600 placeholder-gray-400 outline-none" />
                        </div>
                        {/* Last Name */}
                        <div className="col-span-9 sm:col-span-3">
                            ...
                            <input id="lastName" type="text" name="lastName" {...register('lastName')} className="flex-1 w-3/4 py-2 text-center border-b-2 border-gray-400 focus:border-green-400 text-gray-600 placeholder-gray-400 outline-none" />
                        </div>
                        {/* Middle Initial */}
                        <div className="col-span-9 sm:col-span-3">
                            <label className="block font-bold text-gray-700">Middle Initial</label>
                            <input id="middleInitial" type="text" name="middleInitial" {...register('middleInitial')} className="flex-1 w-1/3 py-2 text-center border-b-2 border-gray-400 focus:border-green-400 text-gray-600 placeholder-gray-400 outline-none" />
                        </div>
                        {/* Date of Birth */}
                        <div className="col-span-9 sm:col-span-3">
                            ...
                            <input id="dateOfBirth" type="date" name="dateOfBirth" {...register('dateOfBirth')} placeholder="date" className="flex-1 w-3/4 py-2 text-center border-b-2 border-gray-400 focus:border-green-400 text-gray-600 placeholder-gray-400 outline-none"></input>
                        </div>
                        {/* Gender */}
                        <div className="col-span-9 sm:col-span-3">
